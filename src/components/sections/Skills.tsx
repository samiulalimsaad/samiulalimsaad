                            ...
                            >
                                        ...
                                        >
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {group.items.map((item) => (
                                                    <span
                                                        key={item}
                                                        className="rounded-full border border-cyan-100 bg-linear-to-r from-cyan-50 via-white to-indigo-50 px-3 py-1 text-[11px] sm:text-xs font-medium text-zinc-800 shadow-sm hover:border-cyan-200"
                                                    >
                                                        {item}
                                                    </span>
                                                ))}
                                ...
                                {tier.groups.length > 2 && (
                                    <button
                                        ...
                                        className="self-start rounded-full border border-cyan-100 bg-white/80 px-3 py-1 text-[11px] font-medium text-cyan-700 shadow-sm hover:border-cyan-200 hover:bg-cyan-50/80"
                                    >
