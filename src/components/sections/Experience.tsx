...
const experiences = [
    {
        ...
        location: experienceFacts[0].location,
        jobMode: "Remote",
        dateFrom: experienceFacts[0].start,
        dateTo: experienceFacts[0].end,
        description: [
            "Own and operate five production services end-to-end: PH Mailer (email platform), SkillMapper (assessment platform), Bootcamp (LMS), JobPortal (recruitment platform), and FTP server. Full ownership across frontend, backend, and infrastructure.",
            "Build and maintain UAT environments and deployment pipelines using Docker and CI/CD. Maintain monitoring and alerting across all services.",
            ...
            "Contributed to the multi-tenant auth platform on ZITADEL: custom Go product layer for SSR UI, security controls (MFA, device limits, rate limiting, CSP/CSRF), and integration logic. Coordinated two mid-level engineers.",
            "Multi-gateway payment service in Go: in development.",
        ],
    },
    {
        designation: experienceFacts[1].title,
        company: experienceFacts[1].employer,
        location: experienceFacts[1].location,
        jobMode: "Remote",
    ...
    },
    {
        ...
        location: experienceFacts[2].location,
    ...
    },
    {
        ...
        location: experienceFacts[3].location,
    ...
    },
    {
        ...
        location: experienceFacts[4].location,
        jobMode: "Remote",
