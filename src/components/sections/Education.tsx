...
export default function Education() {
    return (
        <section id="education" className="w-full py-20 bg-zinc-50">
            <div className="max-w-4xl mx-auto px-6 sm:px-0">
                ...
                <ol className="relative border-s border-indigo-300 ml-4">
                    {educations.map((e, i) => (
                        <li key={i} className="mb-10 ms-6">
                            <span className="absolute flex items-center justify-center w-7 h-7 bg-cyan-400 rounded-full -left-4 ring-2 ring-indigo-200">
                            ...
                            <div className="pl-2">
                                ...
                                <h4 className="text-md text-cyan-700">
                                    {e.subject}
                                </h4>
