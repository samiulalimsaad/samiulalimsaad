                    ...
                    <ol className="relative ml-4 border-s border-indigo-200">
                        {educations.map((e, i) => (
                            <li key={i} className="mb-8 ms-6 last:mb-0">
                                ...
                                <div className="rounded-2xl border border-zinc-100 bg-linear-to-br from-white via-cyan-50/40 to-indigo-50/40 p-4 shadow-sm">
                                    <div className="flex items-start justify-between gap-3">
                                        ...
                                        <span className="mt-1 inline-flex items-center rounded-full border border-indigo-100 bg-white/80 px-3 py-1 text-[11px] font-semibold text-indigo-700 shadow-sm">
                                            {e.year}
                                        </span>
                                    </div>
                                </div>
