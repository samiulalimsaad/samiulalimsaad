            ...
            <div className="pointer-events-auto">
                <div className="relative flex items-end justify-end">
                    ...
                    <label
                        ...
                        className="flex h-11 w-11 cursor-pointer items-center justify-center rounded-full bg-linear-to-br from-indigo-500 to-cyan-500 text-white shadow-lg ring-1 ring-indigo-300/70 transition hover:brightness-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 animate-pulse-soft"
                    >
                    ...
                    <div className="pointer-events-auto absolute bottom-0 right-12 translate-x-4 opacity-0 transition-all duration-200 peer-checked:translate-x-0 peer-checked:opacity-100">
                        <div className="rounded-2xl bg-white/90 px-3 py-2 shadow-xl ring-1 ring-slate-200 backdrop-blur-sm animate-soft-in">
